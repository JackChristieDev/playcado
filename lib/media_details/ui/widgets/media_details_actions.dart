...
import 'package:playcado/cast/ui/widgets/cast_dialog.dart';
    ...
    if (isCasting) {
      final confirmed = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          title: Text(context.l10n.stopCastingConfirmationTitle),
          content: Text(context.l10n.stopCastingConfirmationMessage),
          actions: [
            TextButton(
            ...
            if (downloadItem != null) {
              switch (downloadItem.status) {
                ...
                case DownloadStatus.completed:
                  ...
                  downloadLabel = context.l10n.completed;
                  downloadIconColor = theme.colorScheme.primary;
                  break;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DownloadsBloc, DownloadsState>(
      builder: (context, state) {
        ...
        final duration = Formatters.formatDuration(item.runTimeTicks);
        ...
        } else if (duration.isNotEmpty && !isCasting) {
