...
import 'package:playcado/video_player/ui/video_player.dart';
...
class MediaDetailsHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Episodes rarely have their own backdrops; use the series backdrop if available.
    final backdropId =
        (item.type == MediaItemType.episode && item.seriesId != null)
        ? item.seriesId!
        : item.id;
    final backdropUrl = urlGenerator.getBackdropUrl(backdropId);
