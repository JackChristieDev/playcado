...
import 'package:playcado/paginated_media_list/ui/widgets/media_poster.dart';
import 'package:playcado/paginated_media_list/ui/widgets/media_poster_skeleton.dart';
...
class _PaginatedMediaGridState extends State<PaginatedMediaGrid> {
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) => const MediaPosterSkeleton(width: 160),
                childCount: 12,
              ),
            ),
          ),
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    if (index >= items.length) {
                      return const MediaPosterSkeleton(width: 160);
                    }
                    return MediaPoster(
                      item: items[index],
  ...
  SliverAppBar _buildSliverAppBar(BuildContext context) {
    return SliverAppBar(
      title: IconTitle(title: widget.title),
      floating: true,
      pinned: true,
      snap: true,
      centerTitle: false,
